...
namespace pruebabridge
{
    ...
    class VisualizadorPDF : IExpedienteVisualizador
    {
        public string Visualizar(List<string> datos)
        {
            ...
            FileStream fileStream = new FileStream("D:/Dev/Projects/C#/pruebabridge/expediente.pdf", FileMode.Create);
            ...
            return "El archivo PDF ha sido guardado en la ruta D:/Dev/Projects/C#/pruebabridge/expediente.pdf";
        }
    }
    ...
    public class VisualizadorExcel : IExpedienteVisualizador
    {
        public string Visualizar(List<string> datos)
        {
            ...
            string rutaArchivo = "D:/Dev/Projects/C#/pruebabridge/expediente.xlsx";
            File.WriteAllBytes(rutaArchivo, excel.GetAsByteArray());

            return "El archivo Excel ha sido guardado en la ruta D:/Dev/Projects/C#/pruebabridge/expediente.xlsx";
        }
    }
